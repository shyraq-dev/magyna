...
export default function DeleteAccountButton() {
  ...
  async function remove() {
    const ok = window.confirm(
      "Тіркелгіңізді толығымен жою керек пе? Кітаптарыңыз, пікірлеріңіз, сөреңіз және барлық деректеріңіз қайтарымсыз жойылады."
    );
    if (!ok) return;
  ...
  return (
    <div>
      ...
      >
        {loading ? "Өшірілуде..." : "⚠️ Тіркелгіні жою"}
      </button>
